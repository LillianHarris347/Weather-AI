...
# HTML шаблон с QR-кодом для передачи между телефонами
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="ru">
<head>
...
if __name__ == '__main__':
    ...
    print("📲 На телефоне откройте этот сайт и нажмите кнопку «Поделиться» – появится QR‑код.")
    print("   Второй телефон наведите камеру на QR‑код – откроется та же страница.")
